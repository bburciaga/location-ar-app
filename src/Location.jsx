...
function Box(props) {
  ...
  useFrame((state, delta) => (meshRef.current.position.x = props.rotation.position * Math.PI / 180)) // Rotation in y axis
  //useFrame((state, delta) => (meshRef.current.position.y += -1 * props.rotation.beta * Math.PI / 180)) 
