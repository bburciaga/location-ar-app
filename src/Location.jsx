...
function Box(props) {
  ...
  useFrame((state, delta) => (meshRef.current.position.z += props.rotation.gamma * Math.PI / 180)) // Rotation in y axis
  useFrame((state, delta) => (meshRef.current.position.x += props.rotation.beta * Math.PI / 180))
